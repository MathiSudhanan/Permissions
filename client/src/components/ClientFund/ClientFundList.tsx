...
const ClientFundList = () => {
  const [active, setActive] = React.useState("");

  const [securityLevel, setSecurityLevel] = React.useState("");
  const { clientFundList } = useAppSelector((state) => state.clientFund);
      ...
      >
        <GridList
          ...
          onRowDoubelClick={(row) => {
            const navURL = generatePath("/ClientFund/:id", { id: row.id });
